    ...
    <StarBurst className="min-h-screen" maxHeightPercent={48}>
      <div className="relative flex flex-col min-h-screen text-white">
        <header className="flex justify-end px-5 pt-5">
          ...
          >
            Entrar
            <span className="absolute -bottom-0.5 left-0 w-full h-[2px] rounded-full bg-gradient-to-r from-transparent via-red-light/80 to-transparent shadow-[0_1px_8px_rgba(254,120,113,0.65)]" />
          </button>
        </header>
        ...
        <section className="flex flex-col w-full max-w-sm mx-auto px-6 mt-6 gap-5">
          ...
          <button
            type="submit"
            className="w-full py-3.5 rounded-xl font-bold text-white text-base bg-red border-b-2 border-red-dark active:border-b-0 active:translate-y-[2px] transition-all shadow-lg hover:brightness-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red/60 cursor-pointer mt-1"
          >
            Cadastrar
          </button>
